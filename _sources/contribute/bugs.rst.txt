...
This section guides you through submitting a bug report for the Power Flow Card by Molikk.
...
* **Perform a** `cursory search <https://github.com/molikk/mlk-power-flow-card/issues?q=is%3Aissue>`_
...
and provide the following information by filling in `the template <https://github.com/molikk/mlk-power-flow-card/issues/new?assignees=&labels=type%2Fbug&projects=&template=bug_report.yml>`_.
...
- **Did the problem start happening recently** (e.g. after updating to a new version of HA / Power Flow Card by Molikk) or was this always a problem?
