...
| Visualize Efficiency       | visualize_efficiency:                | `true`   | `false` - Disabled, `true` - Graphic display of Efficiency                                                                                                                                                                                                                                                                                                                                                |
| Show Efficiency in %       | show_mppt_efficiency:                | `false`  | Show % of each MPPT efficiency                                                                                                                                                                                                                                                                                                                                                                            |
| Show Efficiency in kWh/kWp | show_mppt_efficiency_kwhp:           | `false`  | Show kWh/kWp of each MPPT efficiency.                                                                                                                                                                                                                                                                                                                                                                     |
| Show Production            | show_mppt_production:                | `true`   | Show each MPPT energy production                                                                                                                                                                                                                                                                                                                                                                          |
| Hide Header units          | hide_header_units:                   | `false`  | Hides UoM (Units of Measurement) from Header values                                                                                                                                                                                                                                                                                                                                                       |
| Fixed Header Item Width    | fixed_header_item_width:             |          | If set overrides calculated header item width                                                                                                                                                                                                                                                                                                                                                             |
| Header Names               | [Sub-menu](#solar-header-names)      |          | Shows sub-menu with solar header names.                                                                                                                                                                                                                                                                                                                                                                   |
| Header Entities            | [Sub-menu](#solar-header-entities)   |          | Shows sub-menu with solar header entities.                                                                                                                                                                                                                                                                                                                                                                |
...
| PV Names                   | [Sub-menu](#solar-pv-names)          |          | Shows sub-menu with MPPTs Options to set                                                                                                                                                                                                                                                                                                                                                                  |
...
| Hide SOC Shutdown                 | hide_soc_shutdown:                     | `false` | If set to `true` it will hide SOC Shutdown values displayed after SOC                                                                                                                                                                                                                                                                                                                                     |
...
| Show Run to/Charge To in kWh      | runtime_in_kwh:                        | `false` | If set to `true` the displayed RUN TO or CHARGE TO wil be displayed in kWh instead of remaining time.                                                                                                                                                                                                                                                                                                     |
...
| Use Battery Banks Values          | use_battery_banks_values:              | `false` | If set `true` it will use battery banks values to calculate whole battery values                                                                                                                                                                                                                                                                                                                          |
