...
export class Autarky {
	...
	static getTexts(data: DataDto) {
		...
		return svg`
			...
			<text id="ratio" x="${ratio}" y="273" display="${data.enableAutarky === AutarkyType.No ? 'none' : ''}"
				class="st3 left-align" fill="${data.inverterColour}">
