                        ...
                        },
                        {
                            ...
                            schema: [{
                                ...
                                schema: [
                                    ...
                                    {name: 'additional_loads', selector: {number: {mode: 'box', min: 0, max: 8,}}},
                                ...
                                schema: [{
                                    ...
                                    schema: [
                                        ...
                                        {name: 'load5_icon', selector: {entity: {}}},
                                        {name: 'load6_icon', selector: {entity: {}}},
                                        {name: 'load7_icon', selector: {entity: {}}},
                                        {name: 'load8_icon', selector: {entity: {}}},
                            ...
                            schema: [{
                                ...
                                schema: [{
                                    ...
                                    schema: [
                                        ...
                                        {name: "essential_load7_extra", selector: {entity: {}}},
                                        {name: "essential_load7_toggle", selector: {entity: {}}},
                                        {name: "essential_load8", selector: {entity: {device_class: SensorDeviceClass.POWER}}},
                                        {name: "essential_load8_extra", selector: {entity: {}}},
