...
import { UnitOfEnergy, valid3phase, validAuxLoads, validGridConnected, validGridDisconnected, validLoadValues, validNonLoadValues } from './const';
...
export class DataProvider {
	...
	constructor(hass: HomeAssistant, config: PowerFlowCardConfig) {
		this._config = config;
		this.hass = hass;
	}
	...
	public calculateData() {
		...
		const refreshTime = DataProvider.getNowTime();
		...
		} = this.getEssentialLoadExtraEntities();
		const {
			essentialLoadCol1Extra2State,
			essentialLoadCol2Extra2State,
			essentialLoadCol3Extra2State,
			essentialLoadCol4Extra2State,
			essentialLoadCol5Extra2State,
			essentialLoadCol6Extra2State,
		} = this.getEssentialLoadExtra2Entities();
		const {
		...
		} = this.getEssentialLoadToggleEntities();
		...
		const {
			...
			nonEssentialLoadExtra2State,
			nonEssentialLoadToggleState,
		} = this.getNonEssentialEntites();

		//Load aux
		const { stateAuxPower, stateDayAuxEnergy, auxLoadState, auxLoadExtraState, auxLoadExtra2State, auxLoadToggleState } = this.getAuxEntities();
		...
		//Solar
		const { statePvVoltage, statePvCurrent, statePvPower, statePvEnergy } = this.getPvEntities();
		...
		} = this.getEssentialLoadIcons(config);
		const auxLoadIcon = this.getAuxIcons(config);
		const nonessentialLoadIcon = this.getNonessentialLoadIcons(config);
		...
		return { inverterImg, data };
	}


	private getAuxEntities() {
		...
		const auxLoadExtra2State = [
			this.getEntity('entities.aux_load1_extra2'),
			this.getEntity('entities.aux_load2_extra2'),
			this.getEntity('entities.aux_load3_extra2'),
			this.getEntity('entities.aux_load4_extra2'),
			this.getEntity('entities.aux_load5_extra2'),
			this.getEntity('entities.aux_load6_extra2'),
		];
		...
		return { stateAuxPower, stateDayAuxEnergy, auxLoadState, auxLoadExtraState, auxLoadExtra2State, auxLoadToggleState };
	}

	private getNonessentialLoadIcons(config: PowerFlowCardConfig) {
		return [
	...
	private getAuxIcons(config: PowerFlowCardConfig) {
		return [
	...
	private getEssentialLoadIcons(config: PowerFlowCardConfig) {
	...
	private getEssentialLoadColours(config: PowerFlowCardConfig, loadColour: string, stateEssentialLoad1: CustomEntity, stateEssentialLoad1Toggle: CustomEntity, stateEssentialLoad2: CustomEntity, stateEssentialLoad2Toggle: CustomEntity, stateEssentialLoad3: CustomEntity, stateEssentialLoad3Toggle: CustomEntity, stateEssentialLoad4: CustomEntity, stateEssentialLoad4Toggle: CustomEntity, essentialLoadCol1State: CustomEntity[], essentialLoadCol1ToggleState: CustomEntity[], essentialLoadCol2State: CustomEntity[], essentialLoadCol2ToggleState: CustomEntity[], essentialLoadCol3State: CustomEntity[], essentialLoadCol3ToggleState: CustomEntity[], essentialLoadCol4State: CustomEntity[], essentialLoadCol4ToggleState: CustomEntity[], essentialLoadCol5State: CustomEntity[], essentialLoadCol5ToggleState: CustomEntity[], essentialLoadCol6State: CustomEntity[], essentialLoadCol6ToggleState: CustomEntity[]) {
	...
	private getPvEntities() {
		...
		return { statePvVoltage, statePvCurrent, statePvPower, statePvEnergy };
	}

	private getNonEssentialEntites() {
		...
		const nonEssentialLoadExtra2State = [
			this.getEntity('entities.non_essential_load1_extra2'),
			this.getEntity('entities.non_essential_load2_extra2'),
			this.getEntity('entities.non_essential_load3_extra2'),
			this.getEntity('entities.non_essential_load4_extra2'),
			this.getEntity('entities.non_essential_load5_extra2'),
			this.getEntity('entities.non_essential_load6_extra2'),
		];
	...
	private getEssentialLoadToggleEntities() {
	...
	private getEssentialLoadExtra2Entities() {
		const essentialLoadCol1Extra2State = [
			this.getEntity('entities.essential_load_1_1_extra2'),
			this.getEntity('entities.essential_load_1_2_extra2'),
			this.getEntity('entities.essential_load_1_3_extra2'),
			this.getEntity('entities.essential_load_1_4_extra2'),
			this.getEntity('entities.essential_load_1_5_extra2'),
			this.getEntity('entities.essential_load_1_6_extra2'),
		];
		const essentialLoadCol2Extra2State = [
			this.getEntity('entities.essential_load_2_1_extra2'),
			this.getEntity('entities.essential_load_2_2_extra2'),
			this.getEntity('entities.essential_load_2_3_extra2'),
			this.getEntity('entities.essential_load_2_4_extra2'),
			this.getEntity('entities.essential_load_2_5_extra2'),
			this.getEntity('entities.essential_load_2_6_extra2'),
		];
		const essentialLoadCol3Extra2State = [
			this.getEntity('entities.essential_load_3_1_extra2'),
			this.getEntity('entities.essential_load_3_2_extra2'),
			this.getEntity('entities.essential_load_3_3_extra2'),
			this.getEntity('entities.essential_load_3_4_extra2'),
			this.getEntity('entities.essential_load_3_5_extra2'),
			this.getEntity('entities.essential_load_3_6_extra2'),
		];
		const essentialLoadCol4Extra2State = [
			this.getEntity('entities.essential_load_4_1_extra2'),
			this.getEntity('entities.essential_load_4_2_extra2'),
			this.getEntity('entities.essential_load_4_3_extra2'),
			this.getEntity('entities.essential_load_4_4_extra2'),
			this.getEntity('entities.essential_load_4_5_extra2'),
			this.getEntity('entities.essential_load_4_6_extra2'),
		];
		const essentialLoadCol5Extra2State = [
			this.getEntity('entities.essential_load_5_1_extra2'),
			this.getEntity('entities.essential_load_5_2_extra2'),
			this.getEntity('entities.essential_load_5_3_extra2'),
			this.getEntity('entities.essential_load_5_4_extra2'),
			this.getEntity('entities.essential_load_5_5_extra2'),
			this.getEntity('entities.essential_load_5_6_extra2'),
		];
		const essentialLoadCol6Extra2State = [
			this.getEntity('entities.essential_load_6_1_extra2'),
			this.getEntity('entities.essential_load_6_2_extra2'),
			this.getEntity('entities.essential_load_6_3_extra2'),
			this.getEntity('entities.essential_load_6_4_extra2'),
			this.getEntity('entities.essential_load_6_5_extra2'),
			this.getEntity('entities.essential_load_6_6_extra2'),
		];
		return {
			essentialLoadCol1Extra2State,
			essentialLoadCol2Extra2State,
	...
	private getEssentialLoadExtraEntities() {
	...
	private getEssentialLoadEntities() {
	...
	private getBatteryBankEntities(config: PowerFlowCardConfig) {
		const batteryBankPowerState = [
			this.getEntity('entities.battery_power_190'),
