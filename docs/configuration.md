...
| Show Remaining Energy   | show_remaining_energy:                 | `true`  | Set to `true` to display the remaining battery energy in kWh based on the current SOC. Only visible on the `lite` and `full` cards                                                                                                                                                                                                                                                                        |
